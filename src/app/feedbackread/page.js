...
import { Box, Button, Tab, Table, TableCell, TableRow, Typography } from "@mui/material"
            ...
            {feedbacks.map((res,ind)=>{
                return(
                    <Box key={ind} sx={{width:"400px",boxShadow:"2px 2px 4px black",margin:"10px"}}>
                        <Table  sx={{width:"100%"}}>
                            <TableRow>
                                <TableCell>Name :</TableCell> <TableCell>{res.name}</TableCell>
                            </TableRow>
                            <TableRow>
                                <TableCell>Feed Back :</TableCell> <TableCell>{res.content}</TableCell>
                            </TableRow>
                            <TableRow>
                                <TableCell>Posted on :</TableCell> <TableCell>{readable}</TableCell>
                            </TableRow>
                        </Table>
                    </Box>
                )
